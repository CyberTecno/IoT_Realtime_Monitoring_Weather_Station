      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-gutter">
          ...
          <div className="col-span-12 lg:col-span-8 h-[400px] rounded-xl glass overflow-hidden relative group">
            <div className="absolute inset-0 w-full h-full object-cover mix-blend-multiply dark:mix-blend-overlay opacity-60 dark:opacity-40 group-hover:scale-105 transition-transform duration-700 bg-[url('/prasmul.jpg')] bg-cover bg-center"></div>
            <div className="absolute inset-0 bg-gradient-to-t from-background via-background/40 dark:via-transparent to-transparent"></div>
          ...
          <div className="col-span-12 lg:col-span-4 h-[400px] rounded-xl glass p-card-padding flex flex-col relative overflow-hidden">
            <div className="absolute inset-0 z-0 opacity-40 mix-blend-multiply dark:mix-blend-normal dark:opacity-20 bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuCa2eXLCI5xCCO1Yt-ESZOe1ep3E0W78630h0uBApEJUO0OXC0mNFOIXiruhDoG-srwdTSpnL3WXRN8bIonjBGGqHnvGk37ISguTzNR6Q9AYgo19lbJIpX1T5y2XU6dRSPawYpqnlM1v3zwH4y0PsbRirLPbG1r8vJxjyEeQzcPrYPA-IFTAgtEUGNwyOwEfadW-C9KeMtFnuhrhdNy30xLJEIjgha1d1wXtIDXt9HoAxRXynbeacZTAMlZdd5WHnelBfjfx6YcXJY')] bg-cover bg-center"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-gutter">
          ...
          <div className="rounded-xl glass p-card-padding">
            ...
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 rounded-full border-2 border-outline-variant dark:border-white/10 flex items-center justify-center relative">
                <div className="w-1 h-8 bg-primary dark:bg-cyan-400 rounded-full origin-bottom -translate-y-4 rotate-45 transition-transform duration-500" style={{ transform: `translateY(-16px) rotate(${windDir === 'N' ? 0 : windDir === 'NE' ? 45 : windDir === 'E' ? 90 : windDir === 'SE' ? 135 : windDir === 'S' ? 180 : windDir === 'SW' ? 225 : windDir === 'W' ? 270 : 315}deg)` }}></div>
          ...
          <div className="rounded-xl glass p-card-padding">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-body-sm text-on-surface-variant dark:text-slate-300">UV Index</span>
                <span className="px-3 py-1 bg-tertiary-container/30 text-tertiary-fixed text-xs rounded-full font-bold">Moderate 4</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-body-sm text-on-surface-variant dark:text-slate-300">Pressure</span>
                <span className="font-data-mono text-on-surface dark:text-white">{pressure} hPa</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl glass p-card-padding">
            ...
            <div className="flex items-end gap-2 h-16">
              <div className="w-full h-4 bg-surface-container-high dark:bg-white/10 rounded-sm relative overflow-hidden">
                <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-t from-primary dark:from-cyan-400 to-transparent opacity-50"></div>
              </div>
              <div className="w-full h-8 bg-surface-container-high dark:bg-white/10 rounded-sm"></div>
              <div className="w-full h-12 bg-surface-container-high dark:bg-white/10 rounded-sm"></div>
              <div className="w-full h-6 bg-surface-container-high dark:bg-white/10 rounded-sm"></div>
          ...
          <div className="flex justify-between items-center mb-8 relative z-10">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className={`${viewMode === 'satellite' ? 'bg-primary text-on-primary shadow-lg shadow-primary/20' : 'glass hover:bg-surface-container-high dark:bg-white/10 text-on-surface dark:text-white'} px-4 py-2 rounded-lg text-xs font-bold transition-all`}>
                SATELLITE
              </button>
              <button 
                onClick={() => setViewMode('wind')}
                className={`${viewMode === 'wind' ? 'bg-primary text-on-primary shadow-lg shadow-primary/20' : 'glass hover:bg-surface-container-high dark:bg-white/10 text-on-surface dark:text-white'} px-4 py-2 rounded-lg text-xs font-bold transition-all`}>
                WIND FLOW
              </button>
            </div>
          </div>
            ...
            <div className="absolute bottom-6 left-6 glass p-4 rounded-xl flex flex-col gap-3">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-primary dark:bg-cyan-400"></span>
                  <span className="text-[10px] font-bold text-on-surface-variant dark:text-slate-300">STATION FEED</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-tertiary"></span>
                  <span className="text-[10px] font-bold text-on-surface-variant dark:text-slate-300">STORM TRACK</span>
                </div>
              </div>
            </div>
          </div>
