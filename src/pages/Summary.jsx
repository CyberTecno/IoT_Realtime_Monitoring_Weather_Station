      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-gutter">
          ...
          <div className="col-span-12 lg:col-span-8 h-[400px] rounded-xl glass overflow-hidden relative group">
            <div className="absolute inset-0 w-full h-full object-cover opacity-100 group-hover:scale-105 transition-transform duration-700 bg-[url('/prasmul.jpg')] bg-cover bg-center"></div>
            ...
            <div className="absolute bottom-0 left-0 p-8 w-full flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-muted dark:text-slate-400 text-label-caps">STEM STATION • BSD CAMPUS</span>
                </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="text-right">
                  ...
                  <p className="font-data-mono text-primary dark:text-cyan-400 text-header-md">16°C</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 h-[400px] rounded-xl glass p-card-padding flex flex-col relative overflow-hidden">
            <div className="absolute inset-0 z-0 opacity-100 bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuCa2eXLCI5xCCO1Yt-ESZOe1ep3E0W78630h0uBApEJUO0OXC0mNFOIXiruhDoG-srwdTSpnL3WXRN8bIonjBGGqHnvGk37ISguTzNR6Q9AYgo19lbJIpX1T5y2XU6dRSPawYpqnlM1v3zwH4y0PsbRirLPbG1r8vJxjyEeQzcPrYPA-IFTAgtEUGNwyOwEfadW-C9KeMtFnuhrhdNy30xLJEIjgha1d1wXtIDXt9HoAxRXynbeacZTAMlZdd5WHnelBfjfx6YcXJY')] bg-cover bg-center"></div>
